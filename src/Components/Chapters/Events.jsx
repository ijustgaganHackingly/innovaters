  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center z-50 p-4 sm:p-6 md:p-8">
      <div className="flex flex-col items-center justify-center w-full">
        <h1 className="p-[9px] text-4xl">Community Events</h1>
...
//    <h1 className='p-[9px] text-4xl'>Community Events</h1>
//       <h3 className='text-base'>Unite, Inspire & grow with us.</h3>
//       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 w-full sm:w-[90%] md:w-[85%] lg:w-[82%] md:mt-10">
//         {events.map((event, index) => (
//           <div key={index} className="bg-white rounded-[6px] overflow-hidden border border-gray-300 flex flex-col">
