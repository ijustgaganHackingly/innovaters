        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 mr-4">
              <img src="/megaphone.svg" alt="Impact" className="w-10 h-10" />
            </div>
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 mr-4">
              <img src="/megaphone.svg" alt="Leadership" className="w-10 h-10" />
            </div>
            <div className="text-left">
            ...
            <div className="flex items-start">
            <div className="flex-shrink-0 mr-4">
              <img src="/megaphone.svg" alt="Travel" className="w-10 h-10" />
            </div>
            <div className="text-left">
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 mr-4">
              <img src="/megaphone.svg" alt="Networking" className="w-10 h-10" />
            </div>
            <div className="text-left">
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 mr-4">
              <img src="/megaphone.svg" alt="Recognition" className="w-10 h-10" />
            </div>
            <div className="text-left">
          ...
          <div className="flex items-start">
            <div className="flex-shrink-0 mr-4">
              <img src="/megaphone.svg" alt="Future" className="w-10 h-10" />
            </div>
            <div className="text-left">
